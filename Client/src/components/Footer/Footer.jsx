    ...
    return (
        ...
        <div className="end"></div> */}
            <footer className="custom-footer bg-dark text-center text-white">
                ...
                >
                    {/* <Tooltip
                        label="https://github.com/SinghSUBHLEEN/FluxChat"
                        hasArrow
                    >
                            ...
                            <IconButton
                                ...
                                icon={
                                    <a
                                        className="git-link"
                                        target="_blank"
                                        href="https://github.com/SinghSUBHLEEN/FluxChat"
                                    >
                                        <BiLogoGithub fontSize="35px" />
                                    </a>
                                }
                            />
                        </span>
                    ...
                    <Tooltip
                        label="https://www.linkedin.com/in/subhleen-singh-489362169/"
                        hasArrow
                    >
                        <span style={{ margin: "5px" }}>
                            <IconButton
                                ...
                                icon={
                                    <a
                                        className="git-link"
                                        target="_blank"
                                        href="https://www.linkedin.com/in/subhleen-singh-489362169/"
                                    >
                            ...
                            <IconButton
                                ...
                                icon={
                                    <a
                                        className="git-link"
                                        target="_blank"
                                        href="mailto:subhleensingh96@gmail.com"
                                    >
                                        <MdAlternateEmail fontSize="30px" />
                                    </a>
                                }
                            />
                        </span>
